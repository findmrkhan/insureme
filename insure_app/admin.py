...
from .models import (Quote, Policy, PolicyHistory, PolicyMaster
                        , PolicyStatusMaster, QuoteStatusMaster, CurrencyMaster)
...
admin.site.register(PolicyHistory)
admin.site.register(PolicyMaster)
admin.site.register(PolicyStatusMaster)
admin.site.register(QuoteStatusMaster)
